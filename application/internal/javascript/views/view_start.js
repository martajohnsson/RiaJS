...
// men på grund av tidsbrist så skippas det för den här gången. Filerna (tomma!) ligger dock i
// katalogen unused
...
({
	...
	fillDiagram: function()
	{
		...
		if (incomes != 0 || outcomes != 0)
		{
			...
			if (parseInt(incomes) < parseInt(outcomes))
			{
				$('#budgetSummaryIncome').css('color','red');
			}
